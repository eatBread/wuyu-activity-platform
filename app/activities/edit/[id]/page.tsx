...
import { categoryMap, statusMap, getActivityPlansForSelection, observationPoints, getObservationPointsByCategory, addNewActivity, getTemplateById, getActivityById, updateActivity } from '../../../../lib/mockData'
...
function EditActivityContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 调用更新活动函数
      const success = updateActivity(activityId, activityData)
    ...
    if (activityId) {
      ...
      if (activity) {
        setFormData(prev => ({
          ...
          requireRegistration: false, // 默认值
          observationPoints: activity.observationPoints || [], // 加载现有观测点
          processSteps: activity.processSteps || [], // 加载现有流程步骤
          selectedPlans: activity.activityPlan ? [{ planId: '1', planName: activity.activityPlan, direction: activity.activityDirection }] : []
        }))
      }
    }
  }, [activityId])
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">编辑五育活动，修改活动详情和参与规则</p>
                ...
                <div id="process-overview" className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  {formData.processSteps.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">点击"添加环节"开始编辑活动流程</p>
                      <button
                        type="button"
                        onClick={() => setShowAddStepModal(true)}
